const yjExerciseQuestions = [
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["impartial", "vindicated", "skeptical", "complacent"],
    correct: 2,
    explanation: "<strong>Correct Answer: C (skeptical)</strong><br><br>The researchers doubt the company's claims because of data omissions. \"Skeptical\" means having doubts or reservations.<br><br><strong>(B) vindicated</strong> means proven right — but the researchers are raising concerns, not being proven correct. <em>(Wrong stage of argument)</em><br><strong>(A) impartial</strong> means unbiased — while they may be neutral, the passage emphasizes their doubt, not neutrality. <em>(Misses the tone)</em><br><strong>(D) complacent</strong> means self-satisfied and uncritical — the opposite of raising concerns. <em>(Opposite meaning)</em>"
  },
  {
    id: 7,
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["contentious", "negligible", "detrimental", "advantageous"],
    correct: 3,
    explanation: "<strong>Correct Answer: D (advantageous)</strong><br><br>Vendors saw increased customer traffic — a clear positive outcome. \"Advantageous\" means favorable or beneficial.<br><br><strong>(B) negligible</strong> means insignificant — but increased customer traffic is a meaningful impact. <em>(Contradicts evidence)</em><br><strong>(C) detrimental</strong> means harmful — the opposite of the positive outcome described. <em>(Opposite)</em><br><strong>(A) contentious</strong> means controversial — the passage presents a straightforward positive finding, not a debated one. <em>(Wrong tone)</em>"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["erratic", "voracious", "passive", "specialized"],
    correct: 2,
    explanation: "<strong>Correct Answer: C (passive)</strong><br><br>The squid feeds on drifting particles with \"minimal energy expenditure\" — the opposite of active hunting. \"Passive\" means receiving action rather than initiating it.<br><br><strong>(B) voracious</strong> means extremely hungry/greedy — contradicts the gentle, low-energy feeding described. <em>(Opposite)</em><br><strong>(A) erratic</strong> means unpredictable — the passage describes a consistent, low-energy pattern. <em>(Wrong characterization)</em><br><strong>(D) specialized</strong> means adapted for a particular function — while true, it misses the key contrast with active predation that the passage emphasizes. <em>(Too vague for the context)</em>"
  },
  {
    id: 10,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["authentic", "extinct", "prestigious", "provincial"],
    correct: 3,
    explanation: "<strong>Correct Answer: D (provincial)</strong><br><br>The passage describes a shift from dismissal to appreciation. Urban speakers looked down on rural dialects, and now academics value them. \"Provincial\" means narrow, unsophisticated, or associated with rural areas in a dismissive way.<br><br><strong>(B) extinct</strong> means no longer existing — they are still spoken and being studied. <em>(Contradicts passage)</em><br><strong>(C) prestigious</strong> means having high status — opposite of the initial dismissive attitude. <em>(Opposite meaning)</em><br><strong>(A) authentic</strong> means genuine — this is positive, not aligned with the initial dismissiveness. <em>(Wrong tone)</em>"
  },
  {
    id: 12,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["reciprocal", "effusive", "perfunctory", "unsolicited"],
    correct: 2,
    explanation: "<strong>Correct Answer: C (perfunctory)</strong><br><br>The passage contrasts \"frequent, specific praise\" with \"vague statements\" that don't identify achievements. \"Perfunctory\" means carried out with minimal effort or as a routine duty — surface-level acknowledgment.<br><br><strong>(B) effusive</strong> means excessively enthusiastic — the problem described is too little effort, not too much. <em>(Opposite quality)</em><br><strong>(A) reciprocal</strong> means mutual/returned — the passage is about quality of feedback, not whether it goes both ways. <em>(Wrong dimension)</em><br><strong>(D) unsolicited</strong> means not requested — irrelevant to whether the praise is specific or vague. <em>(Wrong dimension)</em>"
  },
  {
    id: 14,
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["prescient", "misleading", "exhaustive", "unprecedented"],
    correct: 1,
    explanation: "<strong>Correct Answer: B (misleading)</strong><br><br>The colon introduces evidence that the \"universal prosperity\" narrative ignores rural hardship. \"Misleading\" means giving a false impression — the narrative is incomplete and therefore inaccurate.<br><br><strong>(A) prescient</strong> means having foresight about the future — irrelevant to accuracy of a historical narrative. <em>(Wrong concept)</em><br><strong>(C) exhaustive</strong> means thorough — the argument is that the narrative is incomplete, not exhaustive. <em>(Opposite)</em><br><strong>(D) unprecedented</strong> means never done before — describes novelty, not accuracy. <em>(Wrong dimension)</em>"
  },
  {
    id: 15,
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["derivative", "prolific", "reclusive", "polemical"],
    correct: 3,
    explanation: "<strong>Correct Answer: D (polemical)</strong><br><br>The contrasting artists published \"manifestos\" and gave \"combative interviews\" — they were aggressively argumentative. \"Polemical\" means strongly critical, argumentative, or controversial.<br><br><strong>(B) prolific</strong> means producing a lot — output quantity isn't the contrast being drawn. <em>(Wrong dimension)</em><br><strong>(C) reclusive</strong> means avoiding others — the passage describes these counterparts as publicly active and vocal. <em>(Opposite)</em><br><strong>(A) derivative</strong> means imitative/unoriginal — the passage is about public combativeness, not originality. <em>(Wrong dimension)</em>"
  },
  {
    id: 16,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical and precise word or phrase?",
    choices: ["flamboyance", "austerity", "spontaneity", "versatility"],
    correct: 1,
    explanation: "<strong>Correct Answer: B (austerity)</strong><br><br>The piece used minimal resources (\"five dancers and a bare stage\") in contrast to spectacle trends. \"Austerity\" means severe simplicity or lack of adornment — stripped-down aesthetic.<br><br><strong>(A) flamboyance</strong> means showy/extravagant — the opposite of the minimalism described. <em>(Opposite)</em><br><strong>(C) spontaneity</strong> means unplanned — the passage doesn't discuss whether the work was planned or improvised. <em>(Wrong dimension)</em><br><strong>(D) versatility</strong> means adaptability — the praise is for restraint, not range. <em>(Wrong quality)</em>"
  },
  // ============================================================
  ...
  // ============================================================
  {
    ...
    choices: ["Young adults in the US spend more time on social media than any previous generation did at the same age.", "Civic participation has also declined among older adults, though to a lesser degree than among young adults.", "Countries with higher rates of geographic mobility among young adults than the US have not experienced similar declines in civic participation.", "Young adults who relocated frequently reported levels of civic participation comparable to those who remained in the same community for over a decade."],
    correct: 3,
    explanation: "<strong>Correct Answer: D</strong><br><br>Marchetti's claim: frequent relocation → weaker community ties → less civic participation. If frequent movers participate at the same rate as non-movers, the relocation mechanism fails.<br><br><strong>(B)</strong> Older adults declining too could suggest a shared cause, but doesn't directly test whether mobility is the driver for young adults. <em>(Tangential)</em><br><strong>(C)</strong> Cross-country comparison introduces confounding variables (different civic cultures, institutions). It's suggestive but less direct than within-US data. <em>(Less direct)</em><br><strong>(A)</strong> Social media use is a separate variable — doesn't address whether mobility specifically matters. <em>(Alternative explanation, doesn't weaken)</em>"
  },
  {
    id: 19,
    ...
    choices: ["Archaeological evidence shows that Mesa Verde's population had already declined by 40% before the drought began in 1276 CE.", "The drought at Mesa Verde was preceded by a decade of above-average rainfall that produced surplus crop yields.", "Several other Puebloan settlements in regions less affected by the drought were also abandoned during the same period.", "Some Puebloan groups who left Mesa Verde eventually settled in areas with comparable rainfall levels."],
    correct: 0,
    explanation: "<strong>Correct Answer: A</strong><br><br>If population was already declining significantly BEFORE the drought started, the drought cannot be the PRIMARY cause of abandonment. The timeline doesn't fit.<br><br><strong>(C)</strong> Other settlements abandoning for unknown reasons doesn't directly address whether drought caused Mesa Verde's abandonment. <em>(Tangential)</em><br><strong>(B)</strong> Prior good rainfall doesn't undermine the drought hypothesis — if anything, it could make the drought more devastating. <em>(Could strengthen)</em><br><strong>(D)</strong> Where people settled afterward doesn't address why they left. <em>(Wrong question)</em>"
  },
  {
    id: 20,
    ...
    choices: ["Children who ate breakfast also tended to come from households with higher incomes and more parental involvement in education than children who skipped breakfast.", "The difference in math scores between breakfast-eaters and breakfast-skippers was larger for younger children than for older children.", "Children who ate breakfast performed similarly to breakfast-skippers on reading comprehension tests.", "Some children who skipped breakfast reported doing so by choice rather than due to food insecurity."],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["Similar orbital shifts occurred at earlier points in Earth's history without producing desertification in North Africa.", "Climate models that include only orbital parameter changes produce a gradual transition over 10,000 years, whereas geological evidence shows the Sahara formed within approximately 500 years.", "The Sahara Desert has experienced brief periods of increased vegetation during the last 5,000 years.", "Other regions at similar latitudes to North Africa did not undergo desertification during the same period."],
    correct: 1,
    explanation: "<strong>Correct Answer: B</strong><br><br>If orbital changes alone predict a 10,000-year gradual change but the actual transition happened in 500 years, orbital changes ALONE cannot explain the speed — additional factors must have been involved. This directly undermines \"alone were sufficient.\"<br><br><strong>(A)</strong> Earlier instances without desertification could mean conditions were different then, not necessarily that orbital changes are insufficient under the right conditions. <em>(Less direct)</em><br><strong>(C)</strong> Brief vegetation periods after formation don't address what caused the initial desertification. <em>(Wrong timeframe)</em><br><strong>(D)</strong> Different regions may have different vegetation, soil, and feedback systems — not a direct test of the orbital mechanism. <em>(Confounding factors)</em>"
  },
  {
    id: 22,
    ...
    choices: ["Participants who were given the mug and asked to evaluate its aesthetic qualities demanded even higher selling prices.", "The price gap was observed in experiments conducted across multiple countries with different cultural attitudes toward material possessions.", "When participants were told they would be given one of two items and could trade after receiving it, the price gap between sellers and buyers disappeared.", "Professional traders who buy and sell goods daily showed a smaller endowment effect than non-traders."],
    correct: 2,
    explanation: "<strong>Correct Answer: C</strong><br><br>If the gap disappears when people expect to trade (reducing attachment/ownership feelings), the gap may be about transaction context rather than loss aversion per se. This challenges loss aversion as THE explanation.<br><br><strong>(B)</strong> Cross-cultural consistency could strengthen the claim that it's a universal psychological effect. <em>(Strengthens)</em><br><strong>(A)</strong> Evaluating aesthetics increasing the price is consistent with, not challenging, the endowment effect. <em>(Supports)</em><br><strong>(D)</strong> Professional traders having less effect could be explained by loss aversion still existing but being overcome by experience — it doesn't challenge the mechanism. <em>(Consistent with theory)</em>"
  },
  {
    id: 23,
    ...
    choices: ["The total amount of REM sleep per night decreases steadily as humans age from infancy to adulthood.", "Rats deprived of all sleep, not just REM sleep, also showed impaired maze performance.", "Humans who report more vivid dreams tend to perform slightly better on memory tests than those who rarely remember dreams.", "Neural recordings taken during REM sleep in rats show reactivation of the exact same hippocampal firing patterns that occurred while the rats were learning the maze."],
    correct: 3,
    explanation: "<strong>Correct Answer: D</strong><br><br>If the brain literally replays learning-specific neural patterns during REM, this directly supports the claim that REM consolidates recently learned information through pathway strengthening.<br><br><strong>(B)</strong> All-sleep deprivation impairing memory doesn't isolate REM — the effect could come from any sleep stage. <em>(Doesn't isolate REM)</em><br><strong>(C)</strong> Dream vividness is a subjective report and not a direct measure of memory consolidation during REM. <em>(Indirect)</em><br><strong>(A)</strong> Age-related REM changes don't address the consolidation mechanism. <em>(Wrong dimension)</em>"
  },
  {
    id: 24,
    ...
    choices: ["Several pastoral populations in East Africa with high exposure to sunlight also have very high rates of lactose tolerance.", "Lactose tolerance in Northern European populations became prevalent approximately 5,000 years ago.", "Vitamin D can also be obtained from fatty fish, which was a dietary staple in many Northern European coastal communities.", "Lactose tolerance is determined by a single genetic mutation that appears to have arisen independently in multiple populations."],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["The number of cycling commuters in Portland had been increasing at a steady rate for a decade before the protected lanes were built.", "Cities that did not add protected bicycle lanes but implemented other cycling incentives, such as subsidized bike-share programs, experienced comparable increases in cycling commuters during the same period.", "Surveys of Portland cyclists found that 80% cited the protected lanes as an important factor in their decision to commute by bicycle.", "The cost of constructing the protected bicycle lanes exceeded initial budget projections by 40%."],
    correct: 0,
    explanation: "<strong>Correct Answer: A</strong><br><br>If cycling was already increasing at the same rate before the lanes were built, the lanes may not have caused the increase — it was a pre-existing trend. This undermines the causal claim.<br><br><strong>(B)</strong> Other cities with different programs succeeding doesn't mean Portland's lanes didn't also work — multiple things can increase cycling. <em>(Doesn't directly weaken)</em><br><strong>(C)</strong> Cyclist surveys actually support Kowalski's claim. <em>(Strengthens)</em><br><strong>(D)</strong> Cost overruns are irrelevant to whether the lanes caused the cycling increase. <em>(Irrelevant)</em>"
  },
  {
    id: 26,
  ...
  },
  {
    ...
    choices: ["Populations that consume high amounts of olive oil but do not follow other aspects of the Mediterranean diet show cardiovascular health outcomes similar to those of populations following the full Mediterranean diet.", "Olive oil contains polyphenols, antioxidant compounds that have been shown to reduce inflammation in laboratory studies.", "The Mediterranean diet has been practiced in various forms for centuries across multiple countries bordering the Mediterranean Sea.", "People who follow the Mediterranean diet tend to exercise more frequently than people who follow other diets."],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["Many companies have begun requiring employees to return to the office at least part-time since 2022.", "Housing prices in small and mid-sized cities were already rising at comparable rates in the five years before widespread remote work adoption.", "The housing markets in expensive metropolitan areas have not experienced significant price declines since 2020.", "Remote workers who relocate to small cities tend to have higher incomes than long-time residents of those cities."],
    correct: 1,
    explanation: "<strong>Correct Answer: B</strong><br><br>If prices were already rising at the same rate before remote work existed, remote work cannot be the PRIMARY driver — the trend predates the proposed cause.<br><br><strong>(A)</strong> Return-to-office policies could weaken Zhang's argument for more recent data, but don't address the initial 2020 price surge. <em>(Partial, not direct)</em><br><strong>(C)</strong> Metro prices not declining doesn't mean remote work isn't increasing demand elsewhere — people leaving doesn't necessarily crash the metro market. <em>(Non sequitur)</em><br><strong>(D)</strong> Income differences explain HOW remote workers could push prices up — this actually supports Zhang. <em>(Strengthens)</em>"
  },
  {
    id: 30,
    ...
    choices: ["Global ocean temperatures have risen significantly over the past century, and kelp is sensitive to warm water.", "Sea urchins are the only herbivore species known to graze on kelp in significant quantities.", "Kelp forests provide critical habitat for hundreds of marine species beyond sea otters and sea urchins.", "In regions where sea otter populations have been successfully reintroduced, kelp forest density has recovered to near-historical levels within a decade."],
    correct: 3,
    explanation: "<strong>Correct Answer: D</strong><br><br>If reintroducing otters → kelp recovery, this is direct evidence of the proposed trophic cascade working in reverse: otters present → urchins controlled → kelp thrives. This is the strongest possible support for the causal chain.<br><br><strong>(B)</strong> Urchins being the only kelp grazer supports one link in the chain but doesn't test whether otters actually control urchin populations effectively. <em>(Partial support)</em><br><strong>(C)</strong> Kelp's ecological importance doesn't address whether otters are the key to kelp survival. <em>(Irrelevant to mechanism)</em><br><strong>(A)</strong> Rising temperatures as an alternative explanation for kelp decline would actually WEAKEN the otter hypothesis. <em>(Weakens)</em>"
  },
  {
    id: 31,
    ...
    choices: ["The bilingual children in the study code-switched at specific conversational junctures — such as when joking or expressing solidarity — rather than at random points in sentences.", "Monolingual children in a control group used slang and informal language at higher rates with peers than with adults.", "The bilingual children performed at or above grade level on standardized language assessments in both Arabic and English.", "Earlier researchers who studied code-switching primarily observed children under the age of five, while Al-Rashidi's subjects were between ages eight and twelve."],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["Fossil evidence suggests that some Jurassic sauropods lived in environments with relatively stable, warm temperatures.", "The largest modern endothermic mammals, such as elephants, are significantly smaller than the largest known sauropods.", "Recent studies show that some modern ectothermic reptiles, such as certain large monitors, can produce bone growth patterns indistinguishable from those of endothermic mammals.", "Computer models indicate that very large animals can maintain stable body temperatures through thermal inertia regardless of whether they are endothermic."],
    correct: 2,
    explanation: "<strong>Correct Answer: C</strong><br><br>Garza's argument: sauropod bone growth patterns resemble endotherms → sauropods were endothermic. If ectotherms CAN produce the same bone patterns, the bone evidence no longer distinguishes between the two — the argument's foundation collapses.<br><br><strong>(B)</strong> Size difference between modern mammals and sauropods doesn't address the bone pattern evidence. <em>(Irrelevant)</em><br><strong>(A)</strong> Warm, stable environments could actually explain how ectotherms could survive at large sizes, but this is an alternative theory rather than a direct challenge to the bone evidence. <em>(Less direct)</em><br><strong>(D)</strong> Thermal inertia is an alternative explanation for temperature stability but doesn't address the specific bone pattern evidence Garza uses. <em>(Parallel argument, doesn't weaken the bone evidence)</em>"
  },
  {
    id: 33,
    ...
    choices: ["Neighborhoods with more independent bookstores also tend to have more restaurants, cafes, and other small businesses.", "Independent bookstores are far more likely to open and survive in neighborhoods that already have low crime rates and high social cohesion.", "Crime rates in neighborhoods with large chain bookstores were not significantly different from those in neighborhoods with independent bookstores.", "Independent bookstore owners surveyed in the study reported hosting an average of four community events per month."],
    correct: 1,
    explanation: "<strong>Correct Answer: B</strong><br><br>Park claims: bookstores → social cohesion → less crime. If bookstores only OPEN in already-safe, cohesive neighborhoods, the causation is reversed — low crime enables bookstores, not the other way around. This is reverse causation.<br><br><strong>(A)</strong> More businesses generally doesn't address whether bookstores specifically drive cohesion — it could suggest general economic health matters, but is less directly undermining. <em>(Alternative explanation, less direct)</em><br><strong>(C)</strong> Chain bookstores having similar effects might actually support the general claim about bookstores and community. <em>(Neutral or slightly strengthens)</em><br><strong>(D)</strong> Community events support the social cohesion mechanism. <em>(Strengthens)</em>"
  },
  {
    id: 34,
    ...
    choices: ["A follow-up study found that the comprehension advantage for the music group was even larger when the articles were on unfamiliar topics.", "Participants who listened to music with lyrics scored lower than both the instrumental music group and the silent group.", "The instrumental music used in the study was selected by the researchers rather than by the participants themselves.", "Participants in the music condition reported feeling less anxious during the task, and reduced anxiety has been independently shown to improve test performance regardless of cognitive enhancement."],
    correct: 3,
    explanation: "<strong>Correct Answer: D</strong><br><br>Arai claims music enhances COGNITIVE PROCESSES of reading. If the real mechanism is anxiety reduction (an emotional/affective pathway, not a cognitive one), then music improves scores WITHOUT actually enhancing cognition — the causal mechanism is wrong even though the effect is real.<br><br><strong>(B)</strong> Lyrics hurting performance is consistent with the idea that verbal interference disrupts reading, which supports a cognitive framework. <em>(Neutral/supports)</em><br><strong>(C)</strong> Who selected the music is a methodological detail that doesn't challenge the cognitive enhancement claim. <em>(Irrelevant to mechanism)</em><br><strong>(A)</strong> A larger effect on unfamiliar topics would suggest music helps with difficult processing — strengthening the claim. <em>(Strengthens)</em>"
  },
  // ============================================================
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical transition?",
    choices: ["For example,", "As a result,", "In contrast,", "In other words,"],
    correct: 2,
    explanation: "<strong>Correct Answer: C (In contrast)</strong><br><br>Japanese bees HAVE a defense; European bees LACK it. This is a direct opposition between two groups.<br><br><strong>(B) As a result</strong> implies the European bees' vulnerability is a consequence of the Japanese bees' defense, which makes no sense. <em>(Wrong causal link)</em><br><strong>(A) For example</strong> would introduce European bees as an instance of the defense behavior, but they actually lack it. <em>(Opposite)</em><br><strong>(D) In other words</strong> restates the same idea differently, but the European bee information is a new, contrasting point. <em>(Wrong function)</em>"
  },
  {
    id: 38,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical transition?",
    choices: ["Consequently,", "By comparison,", "For this reason,", "In other words,"],
    correct: 1,
    explanation: "<strong>Correct Answer: B (By comparison)</strong><br><br>The passage moves from the gratitude group's results (improved) to the control group's results (unchanged). This is a comparison between two groups.<br><br><strong>(A) Consequently</strong> implies the control group's result is a consequence of the gratitude group's result — nonsensical. <em>(Wrong relationship)</em><br><strong>(C) For this reason</strong> implies the control group's stasis was caused by the gratitude group's improvement — also nonsensical. <em>(Wrong relationship)</em><br><strong>(D) In other words</strong> rephrases the same idea, but the control group data is new information about a different group. <em>(Wrong function)</em>"
  },
  {
    id: 45,
  ...
  },
  {
    ...
    question: "Which choice completes the text with the most logical transition?",
    choices: ["For example,", "In contrast,", "On that account,", "Granted,"],
    correct: 2,
    explanation: "<strong>Correct Answer: C (On that account)</strong><br><br>Nussbaum's argument: liberal arts → empathy → democratic citizenship. Therefore, cutting humanities → undermines democracy. The final sentence is a direct consequence of the reasoning chain. \"On that account\" means \"for that reason\" — signaling a conclusion drawn from the preceding argument.<br><br><strong>(B) In contrast</strong> signals opposition, but the final sentence extends the argument. <em>(Wrong relationship)</em><br><strong>(A) For example</strong> introduces an illustration, but this is a broader conclusion, not a specific case. <em>(Wrong function)</em><br><strong>(D) Granted</strong> concedes a point before countering, but no counterargument follows. <em>(Wrong function)</em>"
  }
];
